...
/**
 * AlbumsAdapter is used in VideoListActivity to display list of video(name, image and no. of songs)
 * located in sd-card
 *
...
public class AlbumsAdapter extends RecyclerView.Adapter<AlbumsAdapter.MyViewHolder> {
    ...
    public AlbumsAdapter(Context mContext, List<VideoAlbum> albumList) {
